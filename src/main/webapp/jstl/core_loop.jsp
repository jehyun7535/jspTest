...
<%--
	...
	1-2-3-4-2-3-4-2-3-4
 	...
 	step : 증감 값(default 1)
 	var : 인덱스 변수 or 향상된 for문에서 사용될경우 collection 객체에서 꺼낸 값 설정
	varStatus : 루프변수
		index - 현재 인덱스 값
		count - 루프 실행 횟수
...
<h3>일반 for 문형태</h3>
	<c:forEach begin="0" end="10" var="i" varStatus="loop">
		...
		<%
			...
			//map : 순차적으로 접근이 아닌, 특정 키에의해 원한느 값을 확인하고 싶을 때
	...
	<a href="${pageContext.request.contextPath}/registUser">사용자등록</a> <br>
	<a href="/registUser">사용자 등록</a> <br>
	
	var 속성을 적용하지 않은경우 : 태그를 작성한 곳에 출력<c:url value="/registUser"/><br>
